...
# ====================================================
# 7.5.4 CREAR DATAFRAME NORMALIZADO ÚNICO
# ====================================================
...
if df_normalizado_75.empty:

    st.warning(
        "No se encontraron relaciones normalizadas "
    ...
    st.info(
        "Relaciones normalizadas disponibles: "
        f"{len(df_normalizado_75)}"
    )    
# ========================================================
