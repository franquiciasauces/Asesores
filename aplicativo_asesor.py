    ...
    if not df_repositorio_ejecucion.empty:
        ...
        if df_preguntas_ejecucion.empty:
            ...
            for indice, (
                ...
                st.markdown(
                    f"### Pregunta {indice} "
                    f"de {len(df_preguntas_ejecucion)}"
                )
                    opcion_2_raw = str(
                        fila["Opcion_2"]
                    )
                ...
                if (
                    ...
                    # =================================================
                    # SEPARAR LAS PREGUNTAS DEL REPOSITORIO
                    # =================================================
                    ...
                    registros_opcion_1 = [
                        registro.strip()
                        for registro in opcion_1_raw.split(
                            "EVAL_CONTROLADA_"
                        )
                        if registro.strip()
                    ]
                    ...
                    registros_opcion_2 = [
                        registro.strip()
                        for registro in opcion_2_raw.split(
                            "EVAL_CONTROLADA_"
                        )
                        if registro.strip()
                    ]
                ...
                respuesta_seleccionada = st.radio(
                    ...
                    registros_opcion_3 = [
                        registro.strip()
                        for registro in opcion_3_raw.split(
                            "EVAL_CONTROLADA_"
                        )
                        if registro.strip()
                    ]
                    ...
                    registros_opcion_4 = [
                        registro.strip()
                        for registro in opcion_4_raw.split(
                            "EVAL_CONTROLADA_"
                        )
                        if registro.strip()
                    ]
