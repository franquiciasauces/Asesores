...
# CONSTRUIR DATAFRAME PATOLOGIA-PRODUCTO
# SOLO PRIORIDAD 1
# ============================================================
...
if "df_trabajo_75" not in st.session_state:
    ...
    try:
        ...
        if faltantes_75:
            ...
            st.success(
                f"7.5 Parte 1 cargada: "
                f"{len(df_trabajo_75)} relaciones de prioridad 1."
            )
        ...
        st.error(
            "No fue posible cargar Patologias y Reglas_Paquetes."
        )
